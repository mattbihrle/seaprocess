...
-   `filter_elg()`, which is a function to filter out flow-through data based on a minimum salinity threshold (default 30 psu), or user-defined maximum and minimum values for other flow-through parameter.
