...
-   calc_sheets
    ...
    -   Contains all the calculation sheets needed for your cruise (eg. pH, nitrates, chla, etc)
...
**Errors** mean that something in the code didn't work as intended and processing stopped. If you see errors, double check you entered all data correctly and try to run the script again. If you still encounter errors, consult the "Tips and Tricks" section of [Setup and EOC SeaProcess](Setup_and_Use_SeaProcess.html) doc and your 1st Marine Tech.
...
Seaprocess will also create a "plots" folder that contains plots of basic flow through values as of January 2025. As mentioned above, the output folder should be treated as "read-only." Any edits made here will be erased as soon as the processing script is re-run.
