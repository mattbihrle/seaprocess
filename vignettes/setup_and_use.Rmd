...
-   Click Review \> Unprotect Sheet. This will allow you to add column
    ...
    -   Be intentional when choosing a name for your variable!
        SeaProcess will automatically remove "()", "/", periods, the
        degree symbol, and make all letters lowercase. Additionally "%"
        and "\#" will be replaced by "pct" and "count", respectively.
    -   You are encouraged to stick to letters, numbers, and "\_"
...
removes `%`, periods, dashes, and anything between parentheses. *If you
...
-   SeaProcess will update the variable names in your excel sheet to
    make the outputs more "R friendly." For any added column names you
    are **strongly encouraged** to stick to letters, numbers and "\_"
