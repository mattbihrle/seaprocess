...
Alternatively, say you want to do calculation sheet for reef data. Your function could look like:
`create_datasheet(reef_input, data_type = "REEF", cruiseID = cruiseID, process_calc = T, calc_folder = calc_folder)` **NOTE:** Each datasheet can look through one folder of calc sheets. If you are running calculation sheets for hydrocasts AND for reef data, you will need to define two separate calc_folders. 
