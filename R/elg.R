...
read_elg <- function(filein, forceGPS = NULL, preCheck = TRUE, skip = 0,
                     csv_output = NULL,
                     keep = c("dttm","lon","lat","temp_c","sal_psu","fluor",
                              "cdom","xmiss","wind_sp_kts","wind_dir",
                              "heading","pitch","roll", "wire_tension", "bot_depth_m",
                              "filename")) {
  ...
  args <- tibble::tribble(~name, ~regex, ~parse_fun,
                          ...
                          "wind_sp_kts", "true.*wind.*sp", readr::parse_double,
                          ...
                          "bot_depth_m", c("depth","dbt"), readr::parse_double,
