...
process_wire_log <- function(csv_folder = "output/csv",
  ...
  for(i in 1:length(datasheets)){
    ...
    #see if the datasheet contains a max_wire_out_m column
    if(any(colnames(iii) == "max_wire_out_m")){
